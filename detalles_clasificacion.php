			 	...
			 	$fila = mysqli_fetch_row($result);
					...
					echo '<div >';
						...
						echo '<div class="extra">';
							echo "<br><br><br>";
							echo '<div class="titulos">DESCRIPCION: <textarea rows="4" cols="50" name="comment" form="usrform" style="width:400px;height:50px; min-width:480px"  readonly="readonly">'.$DESC_C.'</textarea> </div><br><br>';
							echo '<br><div class="titulos">SUBCLASIFICACIONES:</div>';
							echo '<form action="detalles_subclas.php" name="form_evento" method="post">';
							echo '<select name="subclas_seleccionada">';
								while($fila2 = mysqli_fetch_row($result2)){
									echo '<option value="'.$fila2[0].'">'.$fila2[0].'</option>';
								}
								echo '</select><br>';
								echo '<br><input type="submit" style="width:250px;height:50px" name="aceptar" value="Ver subclasificacion" class="btn-enviar">';
							echo "</form>";
						echo '</div>';	
					echo '</div>';
			?>
