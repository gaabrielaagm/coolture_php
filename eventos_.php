	...
	<main class="main">
		<div class="contenedor">
			<section>
				...
				<div class="div-tabla">
					<h2 style="color: rgb(0, 0, 77); text-align: center;">Ingresa el evento que deseas buscar </h2>
					<h3 style="color: rgb(0, 0, 77); text-align: center;">(por nombre o por fecha)</h3>
					<br>
