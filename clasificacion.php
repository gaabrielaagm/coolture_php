		...
		<div class="contenedor">
			...
			<?php						
				while($fila = mysqli_fetch_row($result)){
					...
					echo '<form action="detalles_clasificacion.php" name="form_evento" method="post">';
					echo '<div class="grid-1-5">';
						...
						echo '<input type="hidden"  style="width:40px; height:1px" class="transpa" value="'.$ID_C.'" name="valor" readonly="readonly"><br>';
