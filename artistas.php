	...
	<main class="main">
		...
		<div class="contenedor">
			<br><br><center><h1><a href="tabla_ranking.php" style="color: white">¡VER RANKING!</a></h1>
				<a href="eventos_recientes.php" style="color: white">VER MAS RECIENTES</a></h1></center><br><br><br>
			...
			<?php						
				while($fila = mysqli_fetch_row($result)){
					...
					echo '<form action="detalles_artista.php" name="form_evento" method="post">';
