<?php	
	...
	if(!empty($_SESSION["ID_C"])){
		$clasificacion = $_SESSION["ID_C"];
		$conexion = mysqli_connect("localhost", "root", "", "cultura");
		$query = "SELECT NOM_S from subclasificacion where ID_C  = ".$clasificacion.";";
...
<body>
	...
	<div class="banner">
		...
		<div class="contenedor">
			...
			<h2 class="banner__titulo">SELECCIONA SUBCLASIFICACION</h2>
	...
	<section class="seccion-registro">
		<br><br><br><br>
		<form action="obtener_sub_e.php" name="form_evento" method="post" class="form-register"  onsubmit=" return validar_evento()" " >			
			<div class="contenedor-inputs" >				
				<input list="nav" name="subclas">
					<datalist id="nav">
						<?php						
