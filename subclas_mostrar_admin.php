<?php
	...
	$query = "SELECT NOM_S,DESC_S,(SELECT NOM_C from clasificacion where clasificacion.ID_C = subclasificacion.ID_C) as NOM_C, 
	(SELECT ID_C from clasificacion where clasificacion.ID_C = subclasificacion.ID_C) as ID_C,ID_S from subclasificacion";
		...
		<div class="contenedor">
			...
			<?php						
				while($fila = mysqli_fetch_row($result)){
					...
					echo '<form action="detalles_subclas_admin.php" name="form_evento" method="post">';
					echo '<div class="grid-1-5">';
						echo "<br><br>";
						echo '<h2>'.$NOM_C.'</h2><br><hr><br>';
						echo '<h3> » '.$NOM_S. ' «<span class="uppercase"></span> </h3><br><hr><br>';
						switch ($ID_C) {
							case 1:
								echo '<img src="img/danza.jpg" alt="" class="info__img">';
								break;
							case 2:
								echo '<img src="img/pintura.jpeg" alt="" class="info__img">';
								break;
							case 3:
								echo '<img src="img/arqui.jpg" alt="" class="info__img">';
								break;
							case 4:
								echo '<img src="img/escultura.jpg" alt="" class="info__img">';
								break;
							case 5:
								echo '<img src="img/musica.png" alt="" class="info__img">';
								break;
							case 6:
								echo '<img src="img/cine.jpg" alt="" class="info__img">';								
								break;
							case 7:
								echo '<img src="img/literatura.jpg" alt="" class="info__img">';
								break;
						}
						echo "<br>";						
						echo '<input type="hidden"  style="width:40px; height:1px" class="transpa" value="'.$NOM_S.'" name="subclas_seleccionada" readonly="readonly"><br>';
