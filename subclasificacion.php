	...
	<main class="main">
		<div class="contenedor">
			<section>
				...
				<div class="div-tabla">
					<h2 style="color: rgb(0, 0, 77); text-align: center;">Ingresa la subclasificación que deseas buscar </h2>
					<h3 style="color: rgb(0, 0, 77); text-align: center;">(por id o por nombre)</h3>
					<br>
