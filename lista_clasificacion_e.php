...
<header class="header">
	...
	<div class="banner">
		...
		<div class="contenedor">
			...
			<h2 class="banner__titulo">Seleccionar Clasificacion</h2>
	...
	<section class="seccion-registro">
		<br><br><br><br>
		<form action="obtener_clas_e.php" name="form_evento" method="post" class="form-register"  onsubmit=" return validar_evento()" " >			
