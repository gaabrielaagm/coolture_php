...
<body>
	...
	<main class="main">
		<div class="contenedor">
			...
			<br><br><center><h1><a href="tabla_ranking.php" style="color: gray">¡VER RANKING!</a></h1></center><br><br><br>
			<?php						
				while($fila = mysqli_fetch_row($result)){
					...
					echo '<div class="grid-1-5">';
						...
						echo '</ul>';						
						echo 'No. Evento: <input type="text"  style="width:40px; height:1px" class="transpa" value="'.$ID_E.'" name="valor" readonly="readonly"><br>';
